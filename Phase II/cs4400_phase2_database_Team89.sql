...
INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('scooper3@gmail.com','6518555974461663','551', '2024-02-00', ''); 
INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('mgeller5@gmail.com','2328567043101965','644','2024-03-00', ''); 
INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('cbing10@gmail.com','8387952398279291','201', '2023-02-00', ""); 
INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('hwmit@gmail.com','6558859698525299','102','2023-04-00', ""); 
INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('swilson@gmail.com','9383321241981836','455','2022-08-00', ""); 
 INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('aray@tiktok.com','3110266979495605','744','2022-08-00', ""); 
 INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('cdemilio@tiktok.com', '2272355540784744', '606', '2025-02-00', ""); 
 INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('bshelton@gmail.com','9276763978834273','862','2023-09-00', ''); 
 INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('lbryan@gmail.com','4652372688643798','258','2023-05-00', ""); 
 INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('tswift@gmail.com','5478842044367471','857','2024-12-00', ''); 
 INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('jseinfeld@gmail.com','3616897712963372','295','2022-06-00', ''); 
 INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('maddiesmith@gmail.com','9954569863556952','794','2022-07-00', ''); 
 INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('johnthomas@gmail.com','7580327437245356','269','2025-10-00', ''); 
 INSERT INTO customer (username,creditCardNum,CVV,expDate,currentLocation )
 VALUES ('boblee15@gmail.com','7907351371614248','858','2025-11-00', ''); 
...
FOREIGN KEY (arrive_at) REFERENCES airport(airportID)
 ...
 VALUES (1,'Delta Airlines','ATL','JFK', "10:00AM","12:00PM" ,10/18/2021,	400,150); 
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (2,'Southwest Airlines','ORD','MIA',"10:30 AM","2:30 PM",10/18/2021,350,125); 
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (3,'American Airlines','MIA','DFW',"1:00 PM"," 4:00 PM",10/18/2021,350,125); 
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (4,'United Airlines','ATL','LGA'," 4:30 PM"," 6:30 PM",10/18/2021,400,100); 
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (5,'JetBlue Airways','LGA','ATL',"11:00 AM","1:00 PM",10/19/2021,400,130); 
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (6,'Spirit Airlines','SJC','ATL',"12:30 PM","9:30 PM",10/19/2021,650,140);
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (7,'WestJet','LGA','SJC',"1:00 PM","4:00 PM",10/19/2021,700,100); 
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (8,'Interjet','MIA','ORD',"7:30 PM","9:30 PM",	10/19/2021,350,125); 
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (9,'Delta Airlines','JFK','ATL', "8:00 AM", "10:00 AM",10/20/2021,375,150); 
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (10,'Delta Airlines','LAX','ATL',"9:15 AM","6:15 PM",10/20/2021,700,110);
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (11,'Southwest Airlines','LAX','ORD',"12:07 PM","7:07 PM",10/20/2021,600,95); 
 INSERT INTO  flight(flightNum,airlineName  ,depart_from,arrive_at,departureTime,arrivalTime,departingDate,costPerSeat,capacity)
 VALUES (12,'United Airlines','MIA','ATL',"3:35 PM","5:35 PM",10/20/2021,275,115); 
